#!/usr/bin/env python3
"""
Mauboussin 35-Paper Collection Analysis Pipeline
Analyzes all papers using DeepSeek API with appropriate chunking strategy.
"""
...
def main():
    print("=" * 60)
    print("Mauboussin 35-Paper Collection Analysis")
    ...
    print("\n" + "=" * 60)
    print("Processing SHORT papers (<20 pages)")
    print("=" * 60)
    for paper_name, pages in SHORT_PAPERS:
    ...
    print("\n" + "=" * 60)
    print("Processing MEDIUM papers (20-50 pages)")
    print("=" * 60)
    for paper_name, pages in MEDIUM_PAPERS:
        pdf_path = INPUT_DIR / paper_name
        if not pdf_path.exists():
            print(f"\nSkipping {paper_name} (not found)")
            continue
    ...
    print("\n" + "=" * 60)
    print("Processing LARGE papers (>50 pages)")
    print("=" * 60)
    for paper_name, pages in LARGE_PAPERS:
        pdf_path = INPUT_DIR / paper_name
        if not pdf_path.exists():
            print(f"\nSkipping {paper_name} (not found)")
            continue
